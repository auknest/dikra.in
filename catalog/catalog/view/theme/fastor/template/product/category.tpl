...
<div id="mfilter-content-container">
  ...
  <div class="category-info clearfix" style="padding: 0;margin: 0">
    <?php if ($thumb) { ?>
    <div class="image" style="padding: 0"><img src="<?php echo $thumb; ?>" alt="<?php echo $heading_title; ?>" /></div>
    <?php } ?>
    <?php if ($description) { ?>
  ...
  <div class="product-filter clearfix">
  	<div class="options">
  		<div class="product-compare"><?php /* <a href="<?php echo $compare; ?>" id="compare-total"><?php echo $text_compare; ?></a> */ ?></div> 
