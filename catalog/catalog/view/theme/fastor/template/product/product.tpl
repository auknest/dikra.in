    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="<?php echo $size_chart!=''?$size_chart:'#' ?>" id="size_chart" itemprop="image" style="width: 100%" />
            </div>
                ...
                <div class="row" id="quickview_product">
                    ...
                    <div class="col-sm-<?php echo $image_grid; ?> popup-gallery">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-<?php if($theme_options->get( 'position_image_additional' ) == 2) { echo 10; } else { echo 12; } ?>">
                                <?php if (isset($out_of_stock_label_style) && isset($out_of_stock_label_show_marker_in_product_page) && $out_of_stock_label_show_marker_in_product_page) { echo "<style>$out_of_stock_label_style</style>";} ?>
                                ...
                                <div class="not-available-mark"><?php echo $text_out_of_stock; ?></div>
                                <?php } ?>
                                <?php if ($thumb) { ?>

                                <div class="product-image <?php if($theme_options->get( 'product_image_zoom' ) != 2) { if($theme_options->get( 'product_image_zoom' ) == 1) { echo 'inner-cloud-zoom'; } else { echo 'cloud-zoom'; } } ?>" style="border: 0">
                                    ...
                                    <div class="sale"><?php echo round($procent); ?>% OFF</div>
                                    <?php } else { ?>
                                ...
                                <?php } else { ?>
                                <div class="product-image" style="border: 0">
                    ...
                    <div class="col-sm-<?php echo $product_center_grid; ?> product-center clearfix">
                        <div itemscope itemtype="http://schema.org/Offer">
                            ...
                            <div class="review">
                                ...
                                <div class="share">
                                    ...
                                    <script type='text/javascript' src='//platform-api.sharethis.com/js/sharethis.js#property=5c3498edede3ff00103ac0c6&product=sop' async='async'></script>
                                    <!-- AddThis Button END --> 
                                </div>
                                <?php } ?>
                            </div>
                            ...
                            <div class="price">
                                ...
                                <?php } else { ?>
                                <span class="price-new"><span itemprop="price" id="price-special"><?php echo $special; ?></span></span> <span class="price-old" id="price-old"><?php echo $price; ?></span>  (<i style="color: red"><?php echo round($procent); ?>% OFF</i>)
                                <?php } ?>
                                <br />
                                <?php if ($tax) { ?>
                        ...
                        <div id="product">
                            ...
                            <div class="options">
                                ...
                                <div class="options2">
                                    ...
                                    <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
                                        <label class="control-label" for="input-option<?php echo $option['product_option_id']; ?>"><?php echo $option['name']; ?>  <a href="#" data-toggle="modal" data-target="#myModal"> <?php if($size_chart) { ?> &nbsp &nbsp &nbsp  Size Chart > <?php } ?> </a></label>
                            ...
                            <div class="cart">
                                ...
                                <div class="add-to-cart clearfix">
                                    ...
                                    <div class="quantity input-group">
                                        <a id="minus" style="margin: 5px 0 0 0 ;float: left; padding: 13px 8px 14px 9px;border-bottom-right-radius: 0;border-top-right-radius: 0;" type="button" class="btn btn-default btn-number" data-type="minus" data-field="quantity">
                                            <span class="glyphicon glyphicon-minus"></span>
                                        </a>

                                        <input style="border-radius: 0;    margin: 5px 0px !important;" type="text" name="quantity" id="quantity_wanted" size="2" value="<?php echo $minimum; ?>" />
                                        <a href="#" id="q_up"><i class="fa fa-plus"></i></a>
                                        <a href="#" id="q_down"><i class="fa fa-minus"></i></a>
                                        <a id="plus" style="margin: 5px 0 0 0 ;float: left; padding: 13px 8px 14px 9px;border-bottom-left-radius: 0;border-top-left-radius: 0;" type="button" class="btn btn-default btn-number" data-type="plus" data-field="quantity">
                                            <span class="glyphicon glyphicon-plus"></span>
                                        </a>
                                    </div>
                                    &nbsp;<input   type="button" value="Buy Now" id="button-buy" rel="<?php echo $product_id; ?>" data-loading-text="<?php echo $text_loading; ?>" class="button" style="margin-left: 2% !important;padding: 2% 3% 1% 3%;" />
                                    <input  type="button" value="<?php echo $button_cart; ?>" id="button-cart" rel="<?php echo $product_id; ?>" data-loading-text="<?php echo $text_loading; ?>" class="button" style="    padding: 2% 3% 1% 3%;" />
                                    <?php 
                            ...
                            <div class="row">
                                <div class="col-md-12 check_pincode">
                                    <div style="width:100%; float:left; border: 1px solid #E7E7E7; margin:5px 0 15px 0; padding: 4%;">
                                        <form method = "POST" id = "pincheck1" <?php if(isset($pincode)){ echo "style='display:none;'";}?>>
                                              <h4 style="font-size:16px; margin: 1px 0 5px 2px; color: #000;">Check Delivery at Your Location</h4>
                                            <input placeholder="Enter Your Pincode" type="text" id="pin1">
                                            <input type ="button"  class="btn btn-default" onClick = "getdata1()" value="CHECK" style='' />
                                            <div id="show_message" style="display:none; color: red;">Please Enter Postcode</div>
                                        </form>
                                        <div id="msg1" >
                                            <?php
                                            if(isset($pincode)){
                                            echo "<div id='msg' ><p style='background:url(image/catalog/postcode/postcode_icons.jpg);border: 1px solid #EAEAEA; background-repeat: no-repeat;background-position: 3px 3px;float: left;padding: 8px 0 0 22px;height: 35px;'> DELIVERY OPTION FOR : <b>".$pincode."</b>&nbsp;&nbsp;<form style='display:inline;'><input type = 'button'  onclick = 'showform1()' value='CHANGE' style='background: #565656;border: 1px solid #565656;padding: 6px 15px;color: #fff;'  /></form></p>";
                                            echo $pin_check_result;
                                            if(isset($pin_check_delivery) && $pin_check_delivery != ''){
                                            echo $pin_check_delivery;
                                            }
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group required">
                            <div class="col-sm-12">
                                ...
                                <textarea name="text" rows="4" id="input-review" class="form-control" style="height: auto !important"></textarea>
                        ...
                        <div class="form-group  required">
                            <div class="col-sm-12">
                                <div class="file-upload">
                                    <a onclick="$('.file-upload-input').trigger('click')" style="cursor: pointer;">Add Image</a>
                                    <input class="file-upload-input"  name="image" type='file' onchange="readURL(this);" accept="image/*" />

                                    <div class="file-upload-content">
                                        <img class="file-upload-image" src="#" alt="your image" style="max-width: 100px; max-height: 100px;" />
                                        <div class="image-title-wrap">
                                            <a  onclick="removeUpload()" style="cursor: pointer;">change</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="error-container ">
    <div class="error-base-modal item-error-container" id="error_model" style="">
...
<script type="text/javascript"><!--
    $('#plus').click(function () {
    if ($("#quantity_wanted").val() < < ?php echo $stock ? > ) {
...
$('#button-cart').on('click', function() {
    ...
    url: 'index.php?route=checkout/cart/add',
            ...
            //  error_message += json['error']['option'][i];
            error_message += '<div class="text-danger">' + json['error']['option'][i] + '</div>';
            } else {
            error_message += '<div class="text-danger">' + json['error']['option'][i] + '</div>';
            //   error_message += json['error']['option'][i];
            }
            ...
            $("#error_model").html(error_message);
            }
...
$('#button-buy').on('click', function() {
    ...
    url: 'index.php?route=checkout/cart/add',
            ...
            if (json['success']) {
            window.location.href = 'index.php?route=checkout/leo_checkout';
            }
            },
            error: function(xhr, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
...
$('#review').delegate('.pagination a', 'click', function(e) {
    ...
    var myform = document.getElementById("form-review");
