...
if (isset($out_of_stock_label_style)) { echo  "<style>$out_of_stock_label_style</style>";} 
?>

<!-- Product -->
<div class="product clearfix product-hover" title="<?php echo $product['name'] ?>">
    <div class="left">
    ...
    <div class="right">
        <div class="name"><a href="<?php echo $product['href']; ?>"><?php echo substr($product['name'],0,20); ?>...</a></div>
        ...
        <div class="price">
            ...
            <?php } else { ?>
            <span class="price-old"><?php echo $product['price']; ?></span> <span class="price-new"><?php echo $product['special']; ?></span> (<i style="color: red"><?php echo round($procent); ?>% OFF</i>)
            <?php } ?>
        </div>
        <?php } ?>
