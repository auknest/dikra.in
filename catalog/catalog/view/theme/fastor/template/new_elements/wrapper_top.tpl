                ...
                <div class="row">
                    ...
                    <div class="col-md-<?php echo $grid_center; ?>">
                        ...
                        <div class="row">
                            ...
                            ?>
                            <div class="col-md-<?php echo $grid_content_top; ?> center-column <?php if(isset($background_status)) { echo 'content-without-background'; } else { echo 'content-with-background'; } ?>" id="content" style="padding: 0">
