...
<form class="form-horizontal">
    ...
    <?php } ?>
    <br />
    <div id="payment-new" class="row col-md-12" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
        ...
        <div class="form-group ">
            ...
            <div class="form-group col-md-12  required hidden">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 required hidden">
    ...
    <div class="buttons clearfix">
        <div class="pull-right">
            <input  type="button" value="<?php echo $button_continue; ?>" id="button-payment-address" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary hidden" />
        </div>
    </div>
</form>
...
// Sort the custom fields
    $('#payment_address .form-group[data-sort]').detach().each(function () {
        if ($(this).attr('data-sort') >= 0 && $(this).attr('data-sort') <= $('#payment_address .form-group').length - 2) {
            $('#payment_address .form-group').eq(parseInt($(this).attr('data-sort')) + 2).before(this);
        }

        if ($(this).attr('data-sort') > $('#payment_address .form-group').length - 2) {
            $('#payment_address .form-group:last').after(this);
        }
        ...
        if ($(this).attr('data-sort') < -$('#payment_address .form-group').length - 2) {
            $('#payment_address .form-group:first').before(this);
        }
    });
//--></script>
<script type="text/javascript"><!--
