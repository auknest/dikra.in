<div class="panel-default">			
    <legend class="panel-heading"><i class="fa fa-user-plus" aria-hidden="true"></i> New User - Register </legend>
</div>
                ...
                <div class="form-group required">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button type="button" id="button-otp" data-loading-text="Sending..." class="btn btn-primary"><?php echo $text_otp_send ?></button>
                        </span>
                    </div>
                </div>
                <div class="form-group required">
                    <label class="control-label" for="input-payment-telephone-otp">Verify Otp</label>
                    <input type="text" name="telephone_otp" value="<?php echo $telephone_otp ?>" placeholder="Enter OTP" id="input-payment-telephone-otp" class="form-control" />
                </div>
...
// Sort the custom fields
    ...
    $('#payment_address input[name=\'customer_group_id\']').on('change', function () {
        $.ajax({
            url: 'index.php?route=checkout/checkout/customfield&customer_group_id=' + this.value,
            dataType: 'json',
            success: function (json) {
                $('#payment_address .custom-field').hide();
                $('#payment_address .custom-field').removeClass('required');
    ...
    $('#payment_address input[name=\'customer_group_id\']:checked').trigger('change');
//--></script>
<script type="text/javascript"><!--
$('#payment_address button[id^=\'button-payment-custom-field\']').on('click', function () {
        var node = this;
 ...
 $("#button-otp").click(function () {
    ...
    $('#payment_address select[name=\'country_id\']').on('change', function () {
        $.ajax({
            ...
            dataType: 'json',
            beforeSend: function () {
                $('#payment_address select[name=\'country_id\']').after(' <i class="fa fa-circle-o-notch fa-spin"></i>');
            },
            complete: function () {
                $('.fa-spin').remove();
            },
