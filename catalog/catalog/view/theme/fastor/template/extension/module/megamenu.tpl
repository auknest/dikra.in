        ...
        <div class="megamenu-pattern">
            <div class="container">
                <ul class="megamenu <?php if($ustawienia['animation'] != '') { echo $ustawienia['animation']; } ?>">
                    ...
                    if($row['icon']){
                    echo "<a class='cat-img' href='".$row['link']."' class='".$class_link."' ".$target."><span><strong>".$row['icon']."</strong></span></a>";
                    echo "<a href='".$row['link']."' class='".$class_link."' ".$target."><span><strong>".html_entity_decode($row['name'][$lang_id]).html_entity_decode($row['description']).$label."</strong></span></a>";
                    }else{
                     echo "<a style='padding: 25px 2px 22px;height:71px' href='".$row['link']."' class='".$class_link."' ".$target."><span><strong>".html_entity_decode($row['name'][$lang_id]).html_entity_decode($row['description']).$label."</strong></span></a>";
                    }
