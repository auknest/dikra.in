...
{    
    ...
    const USER_LOGIN_EXCEEDED_ATTEMPTS = 'Your account has exceeded allowed number of login attempts. Please try again in 1 hour.';
    const USER_LOGIN_NOT_APPROVED = 'Your account has not been approved. Please contact with the owner shop.';
    ...
    const USER_REGISTER_USER_LOGIN_TOO_LONG = 'The username length is not too short or long. Plase try again.';
    ...
    const USER_REGISTER_PASSWORD_INVALID = 'The password lenght is invalid. Please try again.';
    const USER_REGISTER_PASSWORD_NOT_MACTH_CONFIRM = 'The password confirm is not match with the password. Please try again.';
    ...
    const ORDER_PRODUCT_QUANTITY_LESS_THAN_MIN = 'Minimum order amount for product greater than your pick up';
    ...
    const CART_UNAVAILBLE_STOCK = 'Your cart has more product\'s quantity than store\'s one.';
}