...
/**
 * Description of leo_payment_address
 * 
 * @author leometric
 * 
 * developed by V2
 ...
 */
class ControllerCheckoutLeoPaymentAddress extends Controller {
...
//EOF Pincode        
        ...
        $this->response->setOutput($this->load->view('checkout/leo_payment_address', $data));
    }
