...
/**
 * Description of leo_shipping_method
 * 
 * @author leometric
 * 
 * developed by V2
 ...
 */
class ControllerCheckoutLeoShippingMethod extends Controller {
    ...
    public function index() {
        ...
        $this->response->setOutput($this->load->view('checkout/leo_shipping_method', $data));
    }
