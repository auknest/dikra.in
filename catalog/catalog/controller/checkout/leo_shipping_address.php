...
/**
 * Description of leo_shipping_address
 * 
 * @author leometric
 * 
 * developed by V2
 ...
 */
class ControllerCheckoutLeoShippingAddress extends Controller {
...
//BOF pincode
        ...
        $this->response->setOutput($this->load->view('checkout/leo_shipping_address', $data));
    }
