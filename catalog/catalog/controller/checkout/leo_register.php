 ...
 */
class ControllerCheckoutLeoRegister extends Controller {
    ...
    public function index() {
        ...
        $this->response->setOutput($this->load->view('checkout/leo_register', $data));
    }
    ...
    public function save() {
        ...
        if (!$json) {
            ...
            if ($this->model_account_customer->getTotalCustomersByTelephone($this->request->post['telephone'])) {
                $json['error']['warning'] = "Warning: Number  is already registered!";
            }
            if ((utf8_strlen($this->request->post['telephone']) < 3) || (utf8_strlen($this->request->post['telephone']) > 32)) {
                $json['error']['telephone'] = $this->language->get('error_telephone');
            }
            if (!$this->session->data['otp_' . $this->request->post['telephone']]) {
                $json['error']['telephone'] = 'Verify Mobile Number';
            }

            if ((utf8_strlen(trim($this->request->post['telephone_otp'])) < 3) || (utf8_strlen(trim($this->request->post['telephone_otp'])) > 128)) {
                $json['error']['telephone_otp'] = 'Please Enter OTP';
            }
            if ($this->request->post['telephone'] && isset($this->request->post['telephone_otp']) && trim($this->request->post['telephone_otp']) != $this->session->data['otp_' . $this->request->post['telephone']]) {
                $json['error']['telephone_otp'] = 'Invalid OTP...! Please Try Again';
            }
