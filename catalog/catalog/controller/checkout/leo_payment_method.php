...
/**
 * Description of leo_payment_method
 * 
 * @author leometric
 * 
 * developed by V2
 ...
 */
class ControllerCheckoutLeoPaymentMethod extends Controller {
...
//BOF Pincode
        ...
        if (!isset($this->session->data['payment_methods']['cod'])) {
            if (empty($this->session->data['payment_methods'])) {
                ...
                $data['error_warning'] .= html_entity_decode("Service is not Available at your location yet", ENT_QUOTES, 'UTF-8');
            }
        }
//EOF Pincode
        ...
        $this->response->setOutput($this->load->view('checkout/leo_payment_method', $data));
    }
