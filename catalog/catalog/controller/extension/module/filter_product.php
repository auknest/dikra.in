    ...
    public function index($setting) {
        ...
        if (is_array($setting['tabs'])) {
            ...
            foreach ($tabs as $tab) {
                ...
                if ($tab['title'] == 'latest' || $tab['title'] == 'special' || $tab['title'] == 'bestsellers' || $tab['title'] == 'category' || $tab['title'] == 'random' || $tab['title'] == 'people_also_bought' || $tab['title'] == 'most_viewed' || $tab['title'] == 'related' || $tab['title'] == 'discount') {
                    if ($tab['title'] == 'latest') {
                        $data_products = array(
                            'sort' => 'p.date_added',
                            'order' => 'DESC',
                    ...
                    } elseif ($tab['title'] == 'discount') {
                        $results = $this->model_catalog_product->getDiscountProducts($setting['limit']);
