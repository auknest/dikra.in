          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                                <label class="col-sm-2 control-label">App <?php echo $entry_image; ?></label>
                                <div class="col-sm-10"><a href="" id="thumb-app_image" data-toggle="image" class="img-thumbnail"><img src="<?php echo $app_thumb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                                    <input type="hidden" name="app_image" value="<?php echo $app_image; ?>" id="input-app_image" />
                                </div>
                            </div>
              <div class="form-group">
