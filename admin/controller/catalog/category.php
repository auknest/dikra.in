...
class ControllerCatalogCategory extends Controller {
 ...
 if (isset($this->request->post['app_image'])) {
            $data['app_image'] = $this->request->post['app_image'];
        } elseif (!empty($category_info)) {
            $data['app_image'] = $category_info['app_image'];
        } else {
            $data['app_image'] = '';
        }
 ...
 if (isset($this->request->post['app_image']) && is_file(DIR_IMAGE . $this->request->post['app_image'])) {
            $data['app_thumb'] = $this->model_tool_image->resize($this->request->post['app_image'], 100, 100);
        } elseif (!empty($category_info) && is_file(DIR_IMAGE . $category_info['app_image'])) {
            $data['app_thumb'] = $this->model_tool_image->resize($category_info['app_image'], 100, 100);
        } else {
            $data['app_thumb'] = $this->model_tool_image->resize('no_image.png', 100, 100);
        }
